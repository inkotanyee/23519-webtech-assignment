...
function changeOption() {
  ...
  if (l1.value === "1") {
    l2.innerHTML = 
  "<option>NETWORK</option><option>SOFTWARE</option><option>INFO</option>";
  } else if (l1.value === "2") {
    l2.innerHTML =
  "<option>ACCOUNTING</option><option>MARKETING</option><option>BUSINESS</option>";
  } else if (l1.value === "3") {
    l2.innerHTML =
  "<option>DENTIST</option><option>SURGERY</option><option>AENESTESIA</option>";
  }
else{
...
//  }
 //if( dob.getFullYear() ===""){
   dobError.textContent = "You must be above 18 ";   
}else {
